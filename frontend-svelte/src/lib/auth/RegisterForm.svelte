  ...
  <form on:submit|preventDefault={handleSubmit} class="space-y-4">
    <div>
      ...
      <input
        ...
        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 {formErrors.name ? 'border-red-500' : ''}"
    ...
    <div>
      ...
      <div class="relative">
        <input
          ...
          on:input={clearErrors}
          class="w-full px-3 py-2 pr-10 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 {formErrors.confirmPassword ? 'border-red-500' : ''}"
    ...
    <div class="flex items-center">
      <input id="terms" type="checkbox" required class="mr-2 rounded">
      <label for="terms" class="text-sm text-gray-600">
        I agree to the 
        <button type="button" class="text-blue-600 hover:text-blue-500">Terms of Service</button>
        and 
        <button type="button" class="text-blue-600 hover:text-blue-500">Privacy Policy</button>
      </label>
    </div>
