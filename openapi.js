export default {
  ...
  paths: {
    "/connections": {
      ...
      post: {
        ...
        description: "Create and test a new database connection. Supports both SQLite (file-based) and PostgreSQL (credential or URL-based) connections.",
    ...
    "/connections/test": {
      post: {
        ...
        description: "Test a database connection without saving it. Useful for validating connection parameters before creating a permanent connection.",
    ...
    "/connections/{id}/query": {
      post: {
        ...
        description: "Execute a SQL query on an existing database connection. Supports SELECT, INSERT, UPDATE, DELETE and other SQL operations.",
    ...
    "/connections/{id}/tables": {
      get: {
        ...
        description: "Retrieve a list of all tables in the specified database connection. Automatically filters out system tables for cleaner results.",
        operationId: "getTables",
        tags: ["Schema Browsing"],
        parameters: [
          {
            name: "id",
            in: "path",
  ...
  components: {
    schemas: {
      ...
      TQueryResult: {
        type: "object",
        required: ["result", "executedAt", "query"],
        properties: {
          result: {
            oneOf: [
              {
